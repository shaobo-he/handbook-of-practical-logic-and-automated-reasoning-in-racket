...
(require (only-in "lib.rkt" subtract image insert mapfilter))
(require (only-in "formulas.rkt" list-conj))
(require (only-in "prop.rkt" simpcnf simpdnf))
(require (only-in "fol.rkt" subst generalize))
...
(require (only-in "resolution.rkt" rename resolve-clauses incorporate))
