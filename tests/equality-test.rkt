...
(require rackunit)
(require "../equality/equal.rkt" "../equality/cong.rkt" "../equality/rewrite.rkt" "../equality/order.rkt")
...
(define (num n) (if (= n 0) '(fn |0|) `(fn S ,(num (- n 1)))))
