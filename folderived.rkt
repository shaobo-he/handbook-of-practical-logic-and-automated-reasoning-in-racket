...
(require (only-in "lib.rkt" funpow union unions update undefined))
(require (only-in "formulas.rkt" dest-imp consequent antecedent))
(require (only-in "fol.rkt" subst fv fvt var variant))
(require (only-in "equal.rkt" mk-eq dest-eq lhs rhs))
(require "lcf.rkt")
(require "lcfprop.rkt")
