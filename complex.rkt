...
(require (only-in "lib.rkt" earlier funpow subtract can non))
(require (only-in "formulas.rkt" conjuncts list-conj mk-or end-itlist))
(require (only-in "prop.rkt" dnf negate negative))
