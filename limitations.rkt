...
(require (only-in "lib.rkt" funpow update undefined apply tryapplyd defined first))
(require (only-in "formulas.rkt" consequent))
(require (only-in "fol.rkt" subst fvt))
(require (only-in "equal.rkt" mk-eq dest-eq rhs))
(require "lcf.rkt")
(require "lcfprop.rkt")
